...
const experienceData: IExperience[] = [
  ...
  },
  {
    ...
    description: [
      "During my time as Junior Laboratory Assistant in Software Laboratory Center Binus, I am responsible for teaching several classes for both the BINUS Computer Science and Information Systems majors. Some of the courses that I teach include:",
      "\n",
      ":",
      "- Multimedia Programming Foundation with [Java] using the [JavaFX]",
      "- Computer Graphics using the [WebGL] library [Three.js]",
      "- Computer Vision with [Python] using the [OpenCV]",
